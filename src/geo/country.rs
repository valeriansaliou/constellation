...
impl CountryCode {
    pub fn to_region_code(&self) -> RegionCode {
        match *self {
            ...
            CountryCode::OM => RegionCode::AS,
            CountryCode::PK => RegionCode::AS,
            CountryCode::PW => RegionCode::OC,
            CountryCode::PS => RegionCode::AS,
